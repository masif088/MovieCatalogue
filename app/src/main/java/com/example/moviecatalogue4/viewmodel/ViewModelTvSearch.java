...
public class ViewModelTvSearch extends ViewModel {
    ...
    public void setURL(String query) {
        ...
        String url = "https://api.themoviedb.org/3/search/tv?api_key=" + BuildConfig.TMDB_API_KEY + "&language=" + language + "-US&query="+query;
